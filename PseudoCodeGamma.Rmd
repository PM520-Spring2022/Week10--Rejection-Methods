...
This is an outline of code to implement samploing from gamma random variable using
a rejection method. It is based on the program spuRs/resources/scripts/gamma.sim.r

We will outline a version that uses the exponential envelope. 
The uniform envelope version would replace the definition the X<- below with X<-runif(1,0,C), 
for some large C (try C=20, say)
